...
For this fork's releases, see [Aderon3D/Shizuku](https://github.com/Aderon3D/Shizuku).

## ⬇️ Download

Get the latest [stable](https://github.com/Aderon3D/Shizuku/releases/latest) or [beta](https://github.com/Aderon3D/Shizuku/releases) version.

All versions are distributed via [GitHub Releases](https://github.com/Aderon3D/Shizuku/releases).
...
For setup, info, and troubleshooting steps, see [this README](#user-guide) or the [upstream wiki](https://github.com/thedjchi/Shizuku/wiki).
...
This Shizuku fork and all of its features will always be free, and there will never be ads.
